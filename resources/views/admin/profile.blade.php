...
<div class="page-header p-0 m-0">
    ...
    <div class="cards">
            ...
            <div class="cards__avatar">
                <img src="{{ asset('img/faces/'.$information->profile) }}" alt="profile">
            </div>
            <div class="cards__title">{{Auth::user()->fname}}</div>
            <div class="cards__subtitle"><h5>Type: </h5>{{$information->type}}</div>
            <div class="cards__subtitle"><h5>Status: </h5>{{$information->status}}</div>
    </div>
