                    ...
                    <?php
                            if (DB::connection()->getPdo()) {
                                ...
                                foreach ($title as $test) {
                                    ?>
                            <button class="micButton" onclick="loadScene(<?php echo e($test->id); ?>)"><i class="fa-solid fa-location-arrow"></i></button>
                         <?php
                            }
                            }
                            ?>
...
</html><?php /**PATH C:\xampp\htdocs\3Dscway\BulsuSc\resources\views/mainInterface.blade.php ENDPATH**/ ?>