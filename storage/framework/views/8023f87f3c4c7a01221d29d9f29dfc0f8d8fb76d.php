...
<div class="content-wrapper p-4">
   <div class="page-header ">
      ...
      <form action="<?php echo e(route('createAccount')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
      ...
      <div class="d-flex">
        <div class="cards">
            ...
            <div class="cards__avatar">
                <img src="<?php echo e(asset('img/pro.png')); ?>" class="profile-pic" alt="profile" id="imgprofile" name="imgprofile">
                <div class="p-image">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\3D-SC\resources\views/admin/createAccount.blade.php ENDPATH**/ ?>