<ul class="nav">
          <li class="nav-item nav-profile">
            <a href="<?php echo e(route('profil')); ?>" class="nav-link">
              <div class="nav-profile-image">
                <img src="<?php echo e(asset('img/faces/mark.png')); ?>" alt="profile">
          ...
          <!-- <li class="nav-item  <?php echo e(Request::routeIs('addHotspots') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('addHotspots')); ?>">
              <span class="menu-title">Hotspot</span>
              <i class="fa-solid fa-location menu-icon"></i>
            </a>
          </li>
          <li class="nav-item <?php echo e(Request::routeIs('addScenes') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('addScenes')); ?>">
        ...
        </ul><?php /**PATH C:\xampp\htdocs\3Dscway\BulsuSc\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>