        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('editScene', ['id' => $item->id])); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <div class="d-flex">
                                <div class="circle">
                                  <img class="profile-pic" src="<?php echo e(asset('img/uploads/' . $item->image)); ?>" id="image-preview" alt="Image Preview">
                    ...
                    <div class="d-flex flex-column text-black mb-1 p-2">
                        <label for="title" class="m-0 position-relative fw-normal ">Title Scene</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="text" name="title" required value="<?php echo e($item->title); ?>">
                    </div>
                    <div class="d-flex flex-column text-black p-2">
                        <label for="hfov" class="m-0 position-relative fw-normal "> Hfov</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="number" step="0.1" name="hfov" min="-360" max="360" value="<?php echo e($item->hfov); ?>" required>
                    </div>
                    <div class="d-flex flex-column text-black">
                    ...
                    <div class="d-flex flex-column text-black p-2">
                        <label for="pitch" class="m-0 position-relative fw-normal ">Pitch</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="number" step="0.1" name="pitch" min="-360" max="360" value="<?php echo e($item->pitch); ?>" required>
                    </div>
                    <div class="d-flex flex-column text-black p-2">
                        <label for="yaw" class="m-0 position-relative fw-normal "> Yaw</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="number" step="0.1" name="yaw" min="-360" max="360" value="<?php echo e($item->yaw); ?>" required>
                    </div>                  
                    <div class="d-flex flex-column text-black p-2">
                        <label for="pitch" class="m-0 position-relative fw-normal ">Horizon Roll</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="number" step="0.1" name="horizonRoll" min="-360" max="360" value="<?php echo e($item->horizonRoll); ?>" required>
                    </div>
                    <div class="d-flex flex-column text-black p-2">
                        <label for="pitch" class="m-0 position-relative fw-normal ">Horizon Pitch:</label>
                        <input class="border-top-0 border-start-0 border-end-0 text-center" type="number" step="0.1" name="horizonPitch" min="-360" max="360" value="<?php echo e($item->horizonPitch); ?>" required>
                    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\3Dscway\BulsuSc\resources\views/admin/dataScene.blade.php ENDPATH**/ ?>