...
<div class="page-header p-0 m-0">
    ...
    <div class="d-flex">
    <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $information): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="cards">
            ...
            <div class="cards__avatar">
                <img src="<?php echo e(asset('img/faces/'.$information->profile)); ?>" alt="profile">
            </div>
            <div class="cards__title"><?php echo e(Auth::user()->fname); ?></div>
            <div class="cards__subtitle"><h5>Type: </h5><?php echo e($information->type); ?></div>
            <div class="cards__subtitle"><h5>Status: </h5><?php echo e($information->status); ?></div>
    </div>
  <div class="col-lg col-md col-sm p-4">
    ...
    <div class="card-body">
       ...
       <div class="groupinput">
           ...
           <input class="inputProfile border-top-0 border-start-0 border-end-0 text-center" placeholder="Firstname" type="text" name="fname" autocomplete="off" value="<?php echo e($information->fname); ?>" required>
      </div>
     
      <div class="groupinput">
           <label for="lname">Latstname</label>
           <input class="inputProfile border-top-0 border-start-0 border-end-0 text-center" placeholder="Lastname" type="text" name="lname" value="<?php echo e($information->lname); ?>" autocomplete="off" required>
      </div>
       </div>
      <div class="d-flex col-lg col-md col-sm">
      <div class="groupinput">
           <label for="age">Age</label>
           <input class="inputProfile border-top-0 border-start-0 border-end-0 text-center" placeholder="Age" type="text" name="age" value="<?php echo e($information->age); ?>" autocomplete="off" required>
      </div>
      <div class="groupinput">
           <label for="gender">Gender</label>
           <input class="inputProfile border-top-0 border-start-0 border-end-0 text-center" placeholder="Gender" type="text" name="gender" value="<?php echo e($information->gender); ?>" autocomplete="off" required>
      </div>
      </div>
      <div class="d-flex col-lg col-md col-sm">
      <div class="groupinput">
           <label for="address">Address</label>
           <input class="inputProfile border-top-0 border-start-0 border-end-0 text-center" placeholder="Address" type="text" name="address" value="<?php echo e($information->address); ?>" autocomplete="off" required>
      </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
